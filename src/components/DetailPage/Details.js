...
const Details = () => {
    ...
    return (
        <div className=' flex sm:flex-row flex-col justify-center items-center w-[100%]  h-[100vh] sm:p-8 p-0 gap-8'>
            ...
            <div className='sm:h-full h-1/2 sm:w-1/2 w-[90%]  flex flex-col justify-items-start gap-4'>
              ...
              <div className='flex h-16 items-center  p-2'>
                <button className='p-2 text-center bg-slate-300 h-4/5' style={{ boxShadow: '4px 4px 10px rgba(128, 128, 128, 0.5)' }}>Add to Cart</button>
              </div>
